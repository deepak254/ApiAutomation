...
public class CommonUtil {
     ...
     * @return
     */
    public static String getAbsolutePath(String... strPaths) {
        StringBuffer filePath = new StringBuffer(getProjectDir() + File.separator);
    ...
    public JSONArray readJsonArrayFromFile(String filePath) {
        ...
        try {
            ...
            logger.info("Reading File SuccessFul. File Path "+filePath);
            this.currentTestCase.pass("Reading File SuccessFul. File Path "+filePath);
        } catch (Exception e) {
            logger.log(Level.SEVERE, "Error Reading JSON file from path\n" + filePath);
            logger.log(Level.SEVERE, e.getMessage());
            e.printStackTrace();
            this.currentTestCase.error("Error Reading JSON file from path\n" + filePath);
            this.currentTestCase.error(e);
        }
        return jsonArray;
